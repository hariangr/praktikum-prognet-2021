...
<form action="/adminproductcategories" method="POST" class="needs-validated">
  @csrf
  <div class="form-group">
    <label for="nama">Nama Kategori Produk:</label>
    <input type="text" class="form-control" id="category_name" placeholder="Masukkan Nama Kategori Produk" name="category_name" required>
  </div>
